                ...
                <div className="container flex h-16 items-center">
                    <div className="mr-4 hidden md:flex">
                        ...
                        <nav className="flex items-center space-x-6 text-sm font-medium">
                            <Link href="/explore" className="transition-colors hover:text-foreground/80 text-foreground">Browse</Link>
                            <Link href="/governance" className="transition-colors hover:text-foreground/80 text-foreground">Governance</Link>
                            <Link href="/mint" className="transition-colors hover:text-foreground/80 text-foreground">Mint</Link>
                            <Link href="/profile" className="transition-colors hover:text-foreground/80 text-foreground">Profile</Link>
