      ...
      <div className="container mx-auto px-4 py-8 font-['Inter']">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            <div
              className="inline-flex items-center rounded-full border text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground px-4 py-1"
              data-v0-t="badge"
            >
              <svg
            ...
            >
              ...
              In Stock: {toStriped(purchase!).length}
            </div>
          </div>
        </div>
        <div dir="ltr" data-orientation="horizontal" className="space-y-6">
          ...
          >
            <button
              ...
              role="tab"
              aria-selected="true"
              aria-controls="radix-:r0:-content-owned"
              data-state="active"
            ...
            <button
              ...
              role="tab"
              aria-selected="false"
              aria-controls="radix-:r0:-content-listed"
              data-state="inactive"
              id="radix-:r0:-trigger-listed"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
              tabIndex={-1}
              data-orientation="horizontal"
              data-radix-collection-item=""
            ...
            <button
              ...
              role="tab"
              aria-selected="false"
              aria-controls="radix-:r0:-content-sold"
              data-state="inactive"
              id="radix-:r0:-trigger-sold"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
              tabIndex={-1}
              data-orientation="horizontal"
              data-radix-collection-item=""
          ...
          <div
            ...
            data-orientation="horizontal"
            role="tabpanel"
            aria-labelledby="radix-:r0:-trigger-owned"
            id="radix-:r0:-content-owned"
            tabIndex={0}
          ...
          <div
            ...
            data-orientation="horizontal"
            role="tabpanel"
            aria-labelledby="radix-:r0:-trigger-listed"
            id="radix-:r0:-content-listed"
            tabIndex={0}
            className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 space-y-6"
          ></div>
          <div
            ...
            data-orientation="horizontal"
            role="tabpanel"
            aria-labelledby="radix-:r0:-trigger-sold"
            id="radix-:r0:-content-sold"
            tabIndex={0}
            className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 space-y-6"
          ></div>
        </div>
