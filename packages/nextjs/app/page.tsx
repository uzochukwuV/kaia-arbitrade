      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
        <div className="relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 py-20 relative">
            <div className="max-w-3xl mx-auto text-center space-y-8">
              <div
                className="inline-flex items-center rounded-full border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-green-100 text-green-800 hover:bg-green-100 px-4 py-1 text-sm"
                data-v0-t="badge"
              >
              ...
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
                Decentralized Crop Trading, Reimagined
              </h1>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Trade agricultural assets securely with NFTs, backed by a robust governance system and decentralized
                dispute resolution.
              </p>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div
              className="rounded-lg border text-card-foreground border-none shadow-md bg-white/50 backdrop-blur"
              data-v0-t="card"
            >
              <div className="p-6">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              A revolutionary platform combining traditional agriculture with blockchain technology
            </p>
          </div>
            ...
            <div className="rounded-lg border text-card-foreground border-none shadow-lg bg-white" data-v0-t="card">
              <div className="p-6 space-y-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-sprout h-12 w-12 text-green-600"
                >
                ...
                <p className="text-muted-foreground">
                  Convert your agricultural assets into NFTs for secure and transparent trading
                </p>
              </div>
            </div>
            <div className="rounded-lg border text-card-foreground border-none shadow-lg bg-white" data-v0-t="card">
              <div className="p-6 space-y-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-shield h-12 w-12 text-green-600"
                >
                  <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path>
                </svg>
                <h3 className="text-xl font-semibold">Secure Transactions</h3>
                <p className="text-muted-foreground">
                  Built-in escrow system ensures safe transactions between buyers and sellers
                </p>
              </div>
            </div>
            <div className="rounded-lg border text-card-foreground border-none shadow-lg bg-white" data-v0-t="card">
              <div className="p-6 space-y-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-users h-12 w-12 text-green-600"
                >
                ...
                <p className="text-muted-foreground">
                  Decentralized dispute resolution system powered by community resolvers
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-bar-chart3 h-4 w-4"
                    >
