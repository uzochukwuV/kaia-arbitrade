          ...
          <div className="grid grid-cols-1 md:grid-cols-[240px_1fr] gap-8">
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  >
                    ...
                    >
                      <span data-orientation="horizontal" className="absolute left-0 right-0 h-full bg-primary"></span>
                    </span>
                    <span className=" -translate-x-[50%] absolute left-0">
                      <span
                        role="slider"
                        tabIndex={0}
                ...
                <div className="space-y-4">
                  ...
                  <div dir="ltr" className="relative overflow-hidden h-[200px]">
                    <div
                      ...
                      className="h-full overflow-x-hidden overflow-y-scroll w-full rounded-[inherit]"
                    >
                      <div className=" min-h-[100%] table">
                        <div className="space-y-2">
                          ...
                          <label className="flex items-center space-x-2 cursor-pointer">
                            ...
                            ></button>
                            <span className="text-sm">Fruits &amp; Vegetables</span>
                          </label>
                          <label className="flex items-center space-x-2 cursor-pointer">
                            <button
                              type="button"
                              ...
                              id="Livestock &amp; Dairy"
                            ></button>
                            <span className="text-sm">Livestock &amp; Dairy</span>
                          </label>
                          <label className="flex items-center space-x-2 cursor-pointer">
                            <button
                              type="button"
                              ...
                              id="Seeds &amp; Seedlings"
                            ></button>
                            <span className="text-sm">Seeds &amp; Seedlings</span>
                          </label>
                          <label className="flex items-center space-x-2 cursor-pointer">
                            <button
                              type="button"
                          ...
                          <label className="flex items-center space-x-2 cursor-pointer">
                            <button
                              ...
                              id="Specialty Crops"
                            ></button>
                            <span className="text-sm">Specialty Crops</span>
                          </label>
                        </div>
                      </div>
                    </div>
            ...
            <div className="space-y-6">
              <div className="flex flex-wrap gap-2">
                <div
                  className="rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 flex items-center gap-1"
                  data-v0-t="badge"
                >
                  Price: $0 - $1000
                  <svg
