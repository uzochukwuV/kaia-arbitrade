                ...
                <div dir="ltr" data-orientation="horizontal" className="space-y-4">
                    <div role="tablist" aria-orientation="horizontal"
                        ...
                        tabIndex={0} data-orientation="horizontal" ><button type="button" role="tab"
                            aria-selected="false" aria-controls="radix-:r0:-content-listings" data-state="inactive"
                            ...
                            tabIndex={-1} onClick={() => setTab(TabState.Listings)} >My Sales</button><button
                                type="button" role="tab" aria-selected="false" aria-controls="radix-:r0:-content-purchases"
                                data-state="inactive" id="radix-:r0:-trigger-purchases"
                                className="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
                                tabIndex={-1} onClick={() => setTab(TabState.Purchases)} data-orientation="horizontal" >My Purchases</button>
                    </div>
                    <div data-state="inactive" role="tabpanel"
                        aria-labelledby="radix-:r0:-trigger-listings" id="radix-:r0:-content-listings" tabIndex={0}
                        className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                    ></div>
                    <div data-state="inactive" role="tabpanel"
                        aria-labelledby="radix-:r0:-trigger-purchases" id="radix-:r0:-content-purchases" tabIndex={0}
                        className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                    ></div>
                    {
                        // 
    ...
    return (
        <div>
            <div data-state="active" role="tabpanel" aria-labelledby="radix-:r0:-trigger-purchases"
                id="radix-:r0:-content-purchases" tabIndex={0}
                className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
...
function ActiveListing({data, isLoading}:{data: readonly  BigInt[]| undefined, isLoading:boolean}) {
    ...
    return (
        <div>
            <div data-state="active" role="tabpanel" aria-labelledby="radix-:r0:-trigger-listings"
                id="radix-:r0:-content-listings" tabIndex={0}
                className="mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
                <div className="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
                    <div className="flex flex-col space-y-1.5 p-6">
            ...
            <td className="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                {
                    nft?.payedFor ? <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground bg-green-50"
                        data-v0-t="badge">paid</div> : <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground bg-green-50"
                            data-v0-t="badge">not paid</div>
                }
            </td>
            <td className="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0 space-x-2">
                {
